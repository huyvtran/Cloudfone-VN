...
@interface ChatLeftMediaTableViewCell ()
...
@implementation ChatLeftMediaTableViewCell
...
- (void)updateFramesForAuthorType:(AuthorType)type
{
    ...
    self.horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-8-[Bubble]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(Bubble)];
    ...
    self.horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[Main]-0-|" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(Main)];
    ...
    self.horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[UpCurve]-0-[Main]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(UpCurve,Main)];
    ...
    self.horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[DownCurve]-(-20)-[Main]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(DownCurve,Main)];
    ...
    self.horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[HidingLayerSide]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(HidingLayerSide)];
    ...
    self.horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[chatUserImage]-5-[Main]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatUserImage,Main)];
    ...
    self.horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-30-[chatTimeLabel]-8-|" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatTimeLabel)];
    
    [Main addConstraints:self.horizontal];
    
    NSArray *constraint_POS_H = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-8-[chatMessageBurn]-8-[chatTimeLabel]"
                                                                        options:0
                                                                        metrics:nil
                                                                          views:NSDictionaryOfVariableBindings(chatMessageBurn,chatTimeLabel)];
    self.vertical = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-8-[chatMessageImage]-8-[chatTimeLabel]-8-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(chatMessageImage,chatTimeLabel)];
    
    NSArray *constraint_POS_V = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[chatMessageBurn]-8-|"
                                                                        options:0
                                                                        metrics:nil
                                                                          views:NSDictionaryOfVariableBindings(chatMessageBurn)];
    
    NSArray *tmpWidth = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[chatMessageBurn(16.5)]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatMessageBurn)];
    
    NSArray *tmpHeight = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[chatMessageBurn(16.5)]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatMessageBurn)];
