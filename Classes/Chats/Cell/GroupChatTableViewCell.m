...
- (void)updateFramesForAuthorType:(AuthorType)type
{
    ...
    if(type == iMessageBubbleTableViewCellAuthorTypeSender)
    {
        ...
        //  status
        NSArray *constraint_POS_H = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-8-[chatMessageStatus]-5-[chatTimeLabel]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(chatMessageStatus, chatTimeLabel)];
