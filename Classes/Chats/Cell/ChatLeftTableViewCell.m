...
- (void)updateFramesForAuthorType:(AuthorType)type
{
    ...
    horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-30-[chatTimeLabel]-8-|" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatTimeLabel)];
