...
@interface NewGroupChatViewController : UIViewController<UITextViewDelegate, UITableViewDelegate, UITableViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate, ChatMediaTableViewCellDelegate, GroupChatLeftMediaTableViewCellDelegate>
