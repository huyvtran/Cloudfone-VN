...
- (void) injectMessage:(NSString*)message recipient:(NSString*)recipient accountName:(NSString*)accountName protocol:(NSString*)protocol {
    /*
    OTRBuddy *aBuddy = [[OTRBuddy alloc] initWithDisplayName:[MyFunctions getCloudFoneIDFromString:recipient]
                                                 accountName:recipient protocol:[LinphoneAppDelegate sharedInstance].myBuddy.protocol
                                                      status:1
                                                   groupName:nil];
    
    OTRMessage *newMessage = [OTRMessage messageWithBuddy:aBuddy message:message];
    */
