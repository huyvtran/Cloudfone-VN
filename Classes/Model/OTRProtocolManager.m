    ...
    if(self)
    {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(sendMessage:)
                                                     name:kOTRSendMessage object:nil ];
...
{
    return [buddyList getBuddyForUserName:buddyUserName accountUniqueIdentifier:[self.accountsManager accountForProtocol:protocol accountName:accountName].uniqueIdentifier];
}

- (id <OTRProtocol>)protocolForAccount:(OTRXMPPAccount *)account
{
