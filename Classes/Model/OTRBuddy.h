...
@property (nonatomic, retain) NSString *resourceStr;

@property (nonatomic, retain) NSString* displayName;
@property (nonatomic, retain) NSString* accountName;
@property (nonatomic, retain) NSString* groupName;
@property (nonatomic, retain) NSMutableString* chatHistory;
@property (nonatomic, retain) NSString *messageHistory;
...
@property (nonatomic, retain) NSTimer * pausedChatStateTimer;
@property (nonatomic, retain) NSTimer * inactiveChatStateTimer;
...
@property (nonatomic) sqlite3 *SQLite_Database;
