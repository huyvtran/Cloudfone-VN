...
+(OTRMessage*) decodeMessage:(OTRMessage*)theMessage;
{
    ...
    NSString *decodeMessageString = [[OTRKit sharedInstance] decodeMessage:message recipient:friendAccount accountName:myAccountName protocol:protocol];
    OTRMessage *newOTRMessage = [OTRMessage messageWithBuddy:theMessage.buddy message:decodeMessageString];
...
+(OTRMessage*) encodeMessage:(OTRMessage*)theMessage;
{
    ...
    NSString *encodeMessageString = [[OTRKit sharedInstance] encodeMessage:message recipient:recipientAccount accountName:sendingAccount protocol:protocol];
    
    OTRMessage *newOTRMessage = [OTRMessage messageWithBuddy:theMessage.buddy message:encodeMessageString];
