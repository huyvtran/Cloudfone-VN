...
- (void)removeBuddy: (OTRBuddy *)buddy{
    [[self.allBuddies objectForKey:buddy.protocol.account.uniqueIdentifier] removeObjectForKey:buddy.accountName];
}
...
-(OTRBuddy *)getBuddyForUserName:(NSString *)buddyUserName accountUniqueIdentifier:(NSString *)uniqueIdentifier
{
    ...
    return [[allBuddies objectForKey:UDID] objectForKey:buddyUserName];
}
