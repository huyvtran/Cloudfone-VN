...
- (void)configureRoomAtributes
{
    dispatch_block_t block = ^{ @autoreleasepool {
        ...
        XMPPLogTrace();
        {
            ...
            NSXMLElement *allowInvite = [NSXMLElement elementWithName:@"field"];
            [allowInvite addAttributeWithName:@"var" stringValue:XMPPMUCAllowInvite];
            NSXMLElement *allowInviteValue = [NSXMLElement elementWithName:@"value" numberValue:[NSNumber numberWithInt:1]];
            [allowInvite addChild:allowInviteValue];
            
            NSXMLElement *persistentRoom = [NSXMLElement elementWithName:@"field"];
            [persistentRoom addAttributeWithName:@"var" stringValue:XMPPMUCConfigPersistentRoom];
            NSXMLElement *persistentRoomValue = [NSXMLElement elementWithName:@"value" numberValue:[NSNumber numberWithInt:1]];
            [persistentRoom addChild:persistentRoomValue];
            
            NSXMLElement *membersonly = [NSXMLElement elementWithName:@"field"];
            [membersonly addAttributeWithName:@"var" stringValue:XMPPMUCConfigMemberOnly];
            NSXMLElement *membersonlyValue = [NSXMLElement elementWithName:@"value" numberValue:[NSNumber numberWithInt:0]];
            [membersonly addChild:membersonlyValue];
            
            NSXMLElement *publicroom = [NSXMLElement elementWithName:@"field"];
            [publicroom addAttributeWithName:@"var" stringValue:XMPPMUCConfigPublicRoom];
            NSXMLElement *publicroomValue = [NSXMLElement elementWithName:@"value" numberValue:[NSNumber numberWithInt:1]];
            [publicroom addChild:publicroomValue];
            
            [x addChild:publicroom];
            [x addChild:allowInvite];
            [x addChild:persistentRoom];
            [x addChild:membersonly];
