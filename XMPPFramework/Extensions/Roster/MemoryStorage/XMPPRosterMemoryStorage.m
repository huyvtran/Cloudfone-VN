...
#define AssertPrivateQueue() \
        NSAssert(dispatch_get_main_queue() == parentQueue, @"Private method: MUST run on parentQueue");
#define AssertParentQueue() \
        NSAssert(dispatch_get_main_queue() == parentQueue, @"Private protocol method: MUST run on parentQueue");
...
- (XMPPUserMemoryStorageObject *)myUser
{
	...
	if (dispatch_get_main_queue() == parentQueue)
	{
		return myUser;
	}
	else
